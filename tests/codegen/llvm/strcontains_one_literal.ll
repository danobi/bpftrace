...
strcontains.outer.cond:                           ; preds = %strcontains.outer.incr, %strcontains.empty.check
  ...
  %11 = icmp ne i8 %10, 0
  %12 = and i1 %8, %11
  br i1 %12, label %strcontains.outer.body, label %strcontains.false

strcontains.outer.body:                           ; preds = %strcontains.outer.cond
...
strcontains.inner.cond:                           ; preds = %strcontains.inner.incr, %strcontains.outer.body
  %13 = load i64, ptr %strcontains.j, align 8
  %14 = icmp ult i64 %13, 5
  br i1 %14, label %strcontains.inner.body, label %strcontains.outer.incr

strcontains.inner.body:                           ; preds = %strcontains.inner.cond
  %15 = getelementptr i8, ptr @test, i64 %13
  %16 = load i8, ptr %15, align 1
  %17 = icmp eq i8 %16, 0
  br i1 %17, label %strcontains.true, label %strcontains.inner.notnull

strcontains.inner.notnull:                        ; preds = %strcontains.inner.body
  %18 = add i64 %7, %13
  %19 = icmp uge i64 %18, 1024
  ...
  %24 = or i1 %19, %22
  %25 = or i1 %24, %23
  br i1 %25, label %strcontains.outer.incr, label %strcontains.inner.incr

strcontains.inner.incr:                           ; preds = %strcontains.inner.notnull
  %26 = load i64, ptr %strcontains.j, align 8
  %27 = add i64 %26, 1
  store i64 %27, ptr %strcontains.j, align 8
  br label %strcontains.inner.cond

strcontains.outer.incr:                           ; preds = %strcontains.inner.notnull, %strcontains.inner.cond
  %28 = load i64, ptr %strcontains.i, align 8
  %29 = add i64 %28, 1
  store i64 %29, ptr %strcontains.i, align 8
...
strcontains.false:                                ; preds = %strcontains.outer.cond
  br label %strcontains.done
