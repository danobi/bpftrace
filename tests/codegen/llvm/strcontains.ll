...
strcontains.outer.cond:                           ; preds = %strcontains.outer.incr, %strcontains.empty.check
  ...
  %7 = icmp ne i8 %6, 0
  %8 = and i1 %4, %7
  br i1 %8, label %strcontains.outer.body, label %strcontains.false
...
strcontains.inner.cond:                           ; preds = %strcontains.inner.incr, %strcontains.outer.body
  %9 = load i64, ptr %strcontains.j, align 8
  %10 = icmp ult i64 %9, 5
  br i1 %10, label %strcontains.inner.body, label %strcontains.outer.incr

strcontains.inner.body:                           ; preds = %strcontains.inner.cond
  %11 = getelementptr i8, ptr @test, i64 %9
  %12 = load i8, ptr %11, align 1
  %13 = icmp eq i8 %12, 0
  br i1 %13, label %strcontains.true, label %strcontains.inner.notnull

strcontains.inner.notnull:                        ; preds = %strcontains.inner.body
  %14 = add i64 %3, %9
  %15 = icmp uge i64 %14, 17
  %16 = getelementptr i8, ptr @hello-test-world, i64 %14
